...
public class PluginConfig implements PackageMaterialConfiguration {
    ...
    public static final Property PKG_CONFIG_REPO_ID =
            new PackageMaterialProperty(REPO_ID).with(DISPLAY_NAME, "Repo Id").with(DISPLAY_ORDER, 0);
    public static final Property PKG_CONFIG_GROUP_ID =
            new PackageMaterialProperty(GROUP_ID).with(DISPLAY_NAME, "Group Id").with(DISPLAY_ORDER, 1);

    public static final Property PKG_CONFIG_ARTIFACT_ID =
            new PackageMaterialProperty(ARTIFACT_ID).with(DISPLAY_NAME, "Artifact Id").with(DISPLAY_ORDER, 2);
    ...
    public PackageConfiguration getPackageConfiguration() {
        ...
        packageConfig.add(PKG_CONFIG_REPO_ID);
